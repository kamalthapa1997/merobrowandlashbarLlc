...
import eyelashmain from "../../images/tool.jpg";

import mainthread from "../../images/blkbeauty.jpg";
    ...
    <motion.section className="aboutus">
      ...
      <motion.div className="aboutus__infos">
        <motion.div
          ...
          // animate={controls}
          className="aboutus__details"
        >
          <Transition>
            <p className="aboutus__text ">WELCOME TO</p>
            <h1 className="aboutus__text-title">Mero Brow & Lash Bar</h1>
            <p className="aboutus__texts">
              Welcome to Mero Brow & Lash Bar Your Premier Beauty Destination!
              we specialize in enhancing your natural beauty with precision and
              care. Our expert team is dedicated to providing top-notch eyebrow
              ...
              risk of burns • Precise Control of Shape • Suitable for Short
              hairs
            </p>
          </Transition>
        </motion.div>
